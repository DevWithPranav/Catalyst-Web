...
const ButtonNew = () => {
  return (
    ...
    group
    [&>svg]:h-10 [&>svg]:w-10
    md:text-2xl md:mt-10 md:px-7 md:py-7 sm:text-2xl sm:py-7 sm:px-7
  "
    >
      Execom
      <img
...
const Pioneers = () => {
  return (
    <div className="text-white mx-5 md:mx-15 sm:mx-15">
      <h1 className="text-xl font-primary mb-3 text-left text-white  mt-35 md:text-4xl sm:text-4xl">
        OUR TEAM
      </h1>
      <p className="text-left font-secondary mb-3 leading-loose md:text-xl sm:text-xl ">
      ...
      <p className="text-left font-secondary mb-3 mt-7 leading-loose md:text-xl sm:text-xl ">
      ...
      <p className="text-left font-secondary mb-3 mt-7 leading-loose md:text-2  xl sm:text-xl">
