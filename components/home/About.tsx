...
const About = () => {
  ...
  return (
    <div className="w-screen  mt-52  px-5 relative text-white text-left sm:px-20 ">
      <div>
        <h2 className="text-2xl font-primary mb-3 sm:text-4xl lg:text-5xl ">
          ABOUT US
        </h2>
        <p className="text-sm font-secondary mb-3 leading-loose sm:text-2xl lg:text-3xl lg:mb-10">
