...
const Stats = ({
  ...
  return (
    <div className="w-80 sm:w-120 border mx-auto flex gap-3 mt-10 relative">
    ...
    <div>
      ...
      <div className="relative flex flex-col items-center justify-start h-[100vh] sm:h-[60vh] bg-black overflow-hidden">
        ...
        <div className="relative z-[10] flex flex-col items-center justify-center gap-4 h-full px-4 mt-20">
          ...
          <p className="text-white font-secondary text-center text-sm mx-5 sm:text-md sm:mx-20">
          ...
          <button className="bg-white text-black px-6 py-2 rounded-full font-secondary text-sm sm:text-md font-semibold hover:bg-black hover:text-white hover:scale-105 transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-white/50">
            Join μlearn
          </button>
        </div>
      </div>
      ...
      {/* ---------- STATS SECTION ---------- */}
      <div className="flex flex-col gap-2 mt-[-90] sm:mt-[-50] relative z-20">
        <Tilted />
        ...
        <div className="w-full  bg-[linear-gradient(189.81deg,_#011B7A_15.25%,_#1100D2_37.4%,_#2B20A7_68.93%,_#07005C_102.78%)] skew-y-[-10deg]">
          <div className="skew-y-[10deg] mx-auto mt-20 sm:mt-40 w-[375px] border sm:w-[500px] ">
            <div className="mx-auto text-center sm:mt-10 relative">
              <div className="inline-block">
                <h1 className="text-white font-primary text-4xl sm:text-5xl text-left">
                  CAMPUS
                </h1>
                <h1 className="text-white font-primary text-4xl sm:text-5xl">
                  STATISTICS
                </h1>
              </div>
              <div className=" absolute top-0 right-0 mt-[-50] mr-[40] sm:mt-[-85] sm:mr-[30]">
                <CircularText text="MBCET • MBCET • MBCET • " />
              </div>
            </div>

            <div className=" w-[375px] sm:w-[500px] border mx-auto">
              {/* Wrapper with connecting line */}
              <div className="relative mb-20 sm:mb-40">
                {/* Vertical connecting line that spans all Stats */}
                <div className="absolute left-[12%] sm:left-[7%] top-0 bottom-40 w-[3px] sm:w-[5px] bg-white z-0"></div>
      ...
      <div>
        <div className="text-white font-primary text-3xl text-center mx-10 mt-20">
          ...
          <p className="font-secondary text-sm mx-5 mt-3">
